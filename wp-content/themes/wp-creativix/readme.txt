...
- Edit your header (upload a logo) via WordPress Header Option
- To add Portfolio and Blog page go to "write page" and select "Blog" or "Portfolio" as Template
- To Add Posts/Pages to the Slideshow, select "Feature in Slideshow" when editing post/page/portfolio
- Choose 2 featured Posts to show up on frontage (WP Creativix Options page)
...
2.5
- Fixed General CSS
- Increased width of navbar
- Implemented WordPress Header Options for Logo Upload
- Choose 2 featured posts for Frontpage within WP Creativix Options
- Allow Portfolio Items to show up in the Slider
- Add Current-Page/Current Slider Option
