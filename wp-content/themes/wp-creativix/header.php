...
<div id="wrapper">
	...
	<div id="header_top">
		...
		<div id="logoname">
			...
			$wpcx_header = get_header_image();
			
			if(!empty($wpcx_header)) {
				
				echo "<a href='" . home_url() . "' title='" . get_bloginfo('name') . "'><img src='" . $wpcx_header . "' alt='" . get_bloginfo('name') . "' /></a>";
				...
				echo "<a href='" . home_url() . "' title='" . get_bloginfo('name') . "'>" . $wpcx_logo_name . "</a>";
